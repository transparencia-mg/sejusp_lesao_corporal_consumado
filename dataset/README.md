...
A série disponibilizada contempla registros a partir de 2012. Os dados do arquivo estão organizados por mês e ano do fato, permitindo a análise temporal da ocorrência de Lesão Corporal nos municípios e nas diferentes regiões de segurança pública do Estado.
...
Os dados estão sujeitos a atualizações decorrentes de alterações, correções e atualizações realizadas na base de origem.

## Painel de Lesão Corporal Consumado

[Painel de Lesão Corporal Consumado](https://app.powerbi.com/view?r=eyJrIjoiMmY3NDE0YjktMGRkMC00YTNiLWIxNTAtYTZkMGI2MWQ2YmE2IiwidCI6ImU1ZDNhZTdjLTliMzgtNDhkZS1hMDg3LWY2NzM0YTI4NzU3NCJ9)
